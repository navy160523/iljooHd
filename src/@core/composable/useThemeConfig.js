...
export const useThemeConfig = () => {
  const theme = computed({
    ...
    set(value) {
      const changeThemeEvent = new CustomEvent('changeTheme', { detail: { isDark: value === 'dark' } })
      ...
      localStorage.setItem('grid-theme', value.toString())
  ...
  // `@layouts` exports
  const { navbarType, isNavbarBlurEnabled, footerType, isVerticalNavCollapsed, appContentWidth, appContentLayoutNav, horizontalNavType, isLessThanOverlayNavBreakpoint, isAppRtl, switchToVerticalNavOnLtOverlayNavBreakpoint, tagviewType } = useLayouts()
