...
export const defineThemeConfig = userConfig => {
  ...
  return {
    themeConfig: {
      app: {
        systemCode: userConfig.app.systemCode,
        ...
        supportLocales: userConfig.app.supportLocales,
        apiVersion: userConfig.app.apiVersion,     
        useRestfulAPI: userConfig.app.useRestfulAPI,
        onlyMockup: userConfig.app.onlyMockup,     
        showDetailLog: userConfig.app.showDetailLog,
      },
      navbar: {
      ...
      tagview: {
        type: ref(userConfig.tagview.type),
      },
    },
    layoutConfig: {
      app: {
