...
{
  commonSearchApi({ queryId: 'SPPFF0010_SEARCH_02', 
                    param: {
  ...
  .then(res=>{
    ...
    { 
      ...
      processDetail.value=sData.PROCESS_DETAIL
      processDetailSeq.value=sData.PROCESS_DETAIL_SEQ
      deptNm.value=sData.DEPT_NM
      processNm.value =sData.PROCESS_LOC
...
const saveData = async () => {
  ...
  return commonExecuteApi({ queryId: 'SPPFF0010_SAVE_02', list: saveData })
