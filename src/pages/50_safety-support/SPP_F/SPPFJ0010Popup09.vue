...
const initParams = async (data) => {
  ...
  const res= await commonSearchApi({ queryId: 'SPPFJ0010_SEARCH_19', param: 
...
const psiSearch = (data) =>
{
  ...
  commonSearchApi({ queryId: 'SPPFJ0010_SEARCH_20', param: searchParam})
  .then(res=>{
...
const selectChange = () =>{
  ...
  searchParam.PROCESS_DETAIL_SEQ=processDetail.value==null?0:processDetailSeq.value
