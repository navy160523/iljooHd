...
const openPopup = (isNew, data) => {
  ...
  Promise.all([
    // 항목
    // getCodeList('HHIV020')
    commonSearchnoAuthApi({ queryId: 'SPPFJ0010_SEARCH_22', param: {CMPNY_DIV:'HHI', SYS_COD:'HHIV020'} }),
  ]).then((res) => {
...
const searchRegisterData = param => {
  ...
  commonSearchnoAuthApi({ queryId: 'SPPFJ0010_SEARCH_14', param: param }).then(res => {
...
const searchModifyData = param => {
  ...
  Promise.all([
  commonSearchnoAuthApi({ queryId: 'SPPFJ0010_SEARCH_15', param: param }),
  commonSearchnoAuthApi({ queryId: 'SPPFJ0010_SEARCH_16', param: param })
  ]).then(res => {
...
const searchFile = (fileId, index) => {
  ...
  commonSearchnoAuthApi({ queryId: 'searchFile', param: param }).then(res => {
