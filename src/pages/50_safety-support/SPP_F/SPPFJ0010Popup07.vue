...
const openPopup = async (data) => {
  ...
  Object.assign(saveParam, {
    ...
    EVAL_TYPE: resData.REG_TECH?(resData.REG_TECH=='0'?'0':'1'):'',
    REG_TYPE: '0',
        ...
        <v-container fluid class="searchArea fill-height pa-0">
          <VCol style="height: 100%;">
            ...
            <div class="mb-3">
              ...
              item-value="COD"
              item-title="TXT"
              :disabled="saveParam.DIV === 'Y' || saveParam.DIV === 'N' || popupRead"
              />
            </div>
            ...
            <div v-if="saveParam.EVAL_TYPE === '0'" class="d-flex flex-column">
              <div class="d-flex flex-wrap mb-3">
                <i-select 
                  ...
                  item-title="TXT"
                  required
                  :disabled="saveParam.DIV === 'Y' || popupRead"
                  />
              ...
              <p v-if="saveParam.ADD_DIV === 'Y'" class="text-red">※ 내용 저장 후 파일을 업로드 하실 수 있습니다.</p>
                ...
                <div style="height: 320px;">
                  ...
                  @dataLength="onDataLength1"
                    ...
                    :isVisibled="(saveParam.DIV =='Y' || saveParam.ADD_DIV == 'Y' || popupRead) ? false : true"
                    />
            ...
            <div v-if="saveParam.EVAL_TYPE === '1' || saveParam.IRR_TYPE === '0'" class="d-flex flex-wrap">
                ...
                <div style="width: 100%; height: 320px;">
                  <IUpload ref="fileUpload2" :guid2="saveParam.IRR_FILE_ID" @uploaded="uploaded2" @dataLength="onDataLength2" :isVisibled="(saveParam.DIV =='Y' || saveParam.ADD_DIV == 'Y' || popupRead) ? false : true"/>
                </div>
            </div>
          </VCol> 
        </v-container>
