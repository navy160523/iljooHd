...
const grdMainProps = reactive({
  ...
  fields : [ 
    ...
    { fieldName: 'DONG_NAME',     dataType: 'text', width: '35', styleName: 'center-column editable_column', header: { text:'동명' } },    
    { fieldName: 'PUMP_YN',     dataType: 'text', width: '25',  header: { text:'펌프실' } },    
    { fieldName: 'SHARE_YN',     dataType: 'text', width: '35',  header: { text:'공유건물' } },    
