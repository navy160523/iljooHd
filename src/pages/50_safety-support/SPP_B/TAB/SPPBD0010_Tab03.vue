...
defineOptions({
  name: '50_safety-support-SPP_B-TAB-SPPBD0010_Tab03',
})
...
const onCellDblClicked = (grid,clickData) => {
  ...
  window.sessionStorage.TAB_ID = 'FireTrainingRegister'
  window.sessionStorage.ASGN_CD3 = focusedRow.ASGN_CD
  window.sessionStorage.ASGN_NM3 = focusedRow.ASGN_NM
  window.sessionStorage.BSNS_CD3 = focusedRow.BSNS_CD
  window.sessionStorage.YEAR_DATE3 = searchParams.YEAR_DATE 
  window.sessionStorage.USE_YN3 = 'Y'
