<!-- SPPDA0010Tab1위험기계기구 안전검사 기본정보/압력용기 탭-->
<!-- SI2팀 김성근 2024-04-03  -->
<script setup>
...
<template>
  ...
  <div class="d-flex mt-3">
    ...
    <i-input
      ...
      margin="10px"
      label-width="120px"
      v-model="inputData.DRIVE_CONDITION"
      number
    />
    <i-input
      :label="t('설계온도(℃)')"
  ...
  <div class="d-flex mt-3">
    ...
    <i-input
      ...
      margin="10px"
      label-width="100px"
      v-model="inputData.SAFETY_VALVE"
    />
    <i-input
      :label="t('안전밸브SIZE 입구측')"
      width="270px"
      margin="10px"
      label-width="120px"
      v-model="inputData.VALVE_SIZE1"
      number
    />
    <i-input
      :label="t('안전밸브SIZE 출구측')"
      width="270px"
      margin="10px"
      label-width="120px"
      v-model="inputData.VALVE_SIZE2"
      number
    />
    <i-input
      :label="t('밸브결과')"
      ...
      margin="10px"
      label-width="100px"
      v-model="inputData.VALVE_RESULT"
    />
  </div>
