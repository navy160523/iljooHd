...
const grdMainProps = reactive({
  ...
  fields: [
    ...
    },
    {
      ...
      styleName: "right-column",
      dataType: "text",
      header: { text: t("설계압력(kgf/㎠)") },
      width: 100
    },
    {
      fieldName: "DRIVE_CONDITION",
      styleName: "right-column",
      dataType: "text",
      header: { text: t("운전조건(kgf/㎠)") },
      width: 100
    },
    {
    ...
    {
      fieldName: "VALVE_SIZE1",
      styleName: "right-column",
      dataType: "text",
      header: { text: t("안전밸브SIZE 입구측") },
      width: 120
    },
    {
      fieldName: "VALVE_SIZE2",
      styleName: "right-column",
      dataType: "text",
      header: { text: t("안전밸브SIZE 출구측") },
      width: 120
    },
    {
      fieldName: "SAFETY_VALVE",
      dataType: "text",
      header: { text: t("안전밸브") },
      width: 80
    },
    {
      fieldName: "VALVE_RESULT",
      dataType: "text",
      header: { text: t("밸브결과") },
      width: 80
    },
    ...
    // { fieldName: 'MANAGE_GUA_NM',styleName: "left-column", dataType: 'text',header: { text: t('관리과') } },
    // { fieldName: 'MANAGE_TEAM_NM',styleName: "left-column", dataType: 'text',header: { text: t('관리팀') } },
    // { fieldName: 'EQUIP_KIND_TEST',lookupDisplay: true, dataType: 'text',header: { text: t('검사기준분류') } },
    // { fieldName: 'EQUIP_KIND_DETAIL',lookupDisplay: true, dataType: 'text',header: { text: t('일반기준분류') } },
    // { fieldName: 'EQUIP_SIZE_DETAIL',styleName: "right-column", dataType: 'text',header: { text: t('용량(TON)') } },
  ],
  columns: [],
  columnLayout: [
    "MANAGE_DEPT_NM",
    ...
    },
    {
      name: "제품사양",
      direction: "horizontal",
      items: ["PRESSURE", "DRIVE_CONDITION", "TEMPERATURE"],
      header: {
        text: t("제품사양"),
      },
    },
    ...
    },
    {
      name: "안전밸브사항",
      direction: "horizontal",
      items: ["VALVE_SIZE1", "VALVE_SIZE2", "SAFETY_VALVE", "VALVE_RESULT"],
      header: {
        text: t("안전밸브사항"),
      },
    },
...
onMounted(() => {
  ...
  if (props.intData) {
    let data = props.intData.filter((x) => x.EQUIP_KIND === "B")
  ...
  <v-card class="pa-0 fill-height">
    <div class="content-area">
      <v-sheet height="100%" class="mb-3">
        <RealGrid
          ref="grdMain"
          :style="{ height: exPanVal === 0 ? 'calc(100% - 470px)' : 'calc(100% - 170px)' }"
