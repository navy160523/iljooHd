...
const grdMainProps = reactive({
  ...
  fields: [
    ...
    {
      fieldName: "RATED_OUTPUT",
      dataType: "text",
      header: { text: t("정격출력의합") },
      width: 100
    },
    {
      fieldName: "DISTANCE1",
    ...
    },
    {
      fieldName: "SAFETY_NO",
      dataType: "text",
      header: { text: t("자율안전\n확인번호"), styleName: 'multiline-editor-pre' },
      width: 80
    },
...
onMounted(() => {
  ...
  if (props.intData) {
    let data = props.intData.filter((x) => x.EQUIP_KIND === "I")
