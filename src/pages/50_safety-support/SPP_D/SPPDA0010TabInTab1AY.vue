<!-- SPPDA0010Tab1위험기계기구 안전검사 기본정보/항만크레인 탭-->
<!-- SI2팀 김성근 2024-04-03  -->
<script setup>
...
onMounted(() => {
  Promise.all([
    ...
    codeList.EQUIP_KIND_TEST = res[2].ORESULT_CUR;
    codeList.EQUIP_KIND_DETAIL = res[3].ORESULT_CUR;
    codeList.DRIVE_METHOD = res[4].ORESULT_CUR;
  })
  setClickData()
})
