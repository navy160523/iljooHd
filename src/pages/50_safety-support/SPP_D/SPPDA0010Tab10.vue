<!-- SPPDA0010Tab1위험기계기구 안전검사 이동식카크레인-->
<!-- SI2팀 김성근 2024-04-03  -->
<script setup>
...
const grdMainProps = reactive({
  ...
  fields: [
    ...
    },
    {
      ...
      styleName: "right-column",
      dataType: "text",
      header: { text: t("공구중심점(TCP) 최대속도"), styleName: 'multiline-editor-pre'},
      width: 150
    },
    {
      fieldName: "MOTER_OUTPUT",
      styleName: "right-column",
      dataType: "text",
      header: { text: t("각 구동 모터 정격출력"), styleName: 'multiline-editor-pre' },
      width: 200
    },
    {
...
onMounted(() => {
  ...
  if (props.intData) {
    let data = props.intData.filter((x) => x.EQUIP_KIND === "J")
  ...
  <v-card class="pa-0 fill-height">
    <div class="content-area">
      <v-sheet height="100%" class="mb-3">
        <RealGrid
          ref="grdMain"
          :style="{ height: exPanVal === 0 ? 'calc(100% - 585px)' : 'calc(100% - 290px)' }"
