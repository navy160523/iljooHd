  ...
  commonSearchApi({
    ...
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] == 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[0].data.push(res.ORESULT_CUR[3][columnName[i]]) //20대
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[1].data.push(res.ORESULT_CUR[4][columnName[i]]) //30대
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[2].data.push(res.ORESULT_CUR[5][columnName[i]]) //40대
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[3].data.push(res.ORESULT_CUR[6][columnName[i]]) //50대
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[4].data.push(res.ORESULT_CUR[7][columnName[i]]) //60대 이상
      }
    }
  })
  commonSearchApi({
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'C02'">
      ...
      <div class="d-flex flex-column fill-height">
        ...
        <v-card-text class="content-area">
          <v-sheet class="pa-0 h-auto">
            ...
            <div style="text-align: end">[단위:세]</div>
            <div>
              <v-sheet class="pa-0 h-auto">
                <RealGrid
                  ref="grdMain"
