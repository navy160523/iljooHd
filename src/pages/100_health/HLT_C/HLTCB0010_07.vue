...
const btnSearch = () => {
  ...
  commonSearchApi({
    ...
    // console.log('chartsOptions.series[0].data', chartsOptions.series[0].data)
  })
  commonSearchApi({
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'B01'">
