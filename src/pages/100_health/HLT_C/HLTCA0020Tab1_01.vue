...
const initCodeList = () => {
  ...
  if (userStore.authGrpCd.includes('HLTC001') 
...
<template>
  <v-card class="pa-0 fill-height">
    <v-card-title class="pa-3 pb-0">
      ...
      <IGridTitle v-if="isAdmin" :button-list="['btnIndicator', 'btnSearch']" @click-button="onButtonsClick" />
    </v-card-title>
