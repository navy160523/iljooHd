...
const searchData = () => {
  ...
  return commonSearchApi({
    queryId: 'HLTCA0020_SEARCH2_01_POPUP',
    param: searchParam,
  })
}
...
const afterSearch = (res) => {
  ...
  // 숫자로 들어온 값을 그대로 매핑
  saveParams.GEN_TGT   = row.GEN_TGT ?? null
  saveParams.GEN_DO    = row.GEN_DO ?? null
  saveParams.SP_HI_TGT = row.SP_HI_TGT ?? null
  saveParams.SP_HI_DO  = row.SP_HI_DO ?? null
  saveParams.SP_LO_TGT = row.SP_LO_TGT ?? null
  saveParams.SP_LO_DO  = row.SP_LO_DO ?? null
  saveParams.COMP_TGT  = row.COMP_TGT ?? null
  saveParams.COMP_DO   = row.COMP_DO ?? null
}
...
const saveData = () => {
  ...
  // 변환이 필요한 키 목록
  const numberKeys = ["GEN_TGT", "GEN_DO", "SP_HI_TGT", "SP_HI_DO", "SP_LO_TGT", "SP_LO_DO", "COMP_TGT", "COMP_DO"];
  ...
  return commonExecuteApi({ queryId : 'HLTCA0020_SEARCH2_01_SAVE', list: [params] })
}
          ...
          <v-window v-model="tab" class="h-window">
            <v-window-item value="tab1">
              ...
              <v-sheet class="pa-0 mr-3">
                  ...
                  <i-input
                    v-model="saveParams.GEN_TGT"
                    :label="$t('일반 건강진단 대상(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  <i-input
                    v-model="saveParams.GEN_DO"
                    :label="$t('일반 건강진단 실시(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  ...
                  <i-input
                    v-model="saveParams.SP_HI_TGT"
                    :label="$t('특수 건강진단 상반기 대상(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  <i-input
                    v-model="saveParams.SP_HI_DO"
                    :label="$t('특수 건강진단 상반기 실시(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  <i-input
                    v-model="saveParams.SP_LO_TGT"
                    :label="$t('특수 건강진단 하반기 대상(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  <i-input
                    v-model="saveParams.SP_LO_DO"
                    :label="$t('특수 건강진단 하반기 실시(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  ...
                  <i-input
                    v-model="saveParams.COMP_TGT"
                    :label="$t('종합 건강진단 대상(명)')"
                    label-width="170px" 
                    width="250px"
                    style="margin-bottom: 10px"
                  />
                  <i-input
                    v-model="saveParams.COMP_DO"
                    :label="$t('종합 건강진단 실시(명)')"
                    label-width="170px" 
                    width="250px"
                  />
                </v-sheet>
