...
const initCodeList = () => {
  Promise.all([
    ...
    codeList.IND_NM = props.codeArray2.filter((x) => x.COD.includes('A'))
  })
}
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'A05'">
