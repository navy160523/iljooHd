...
const searchData = () => {
  ...
  return commonSearchApi({
    queryId: 'HLTCA0020_SEARCH5_03_POPUP',
    param: searchParam,
  })
}
...
const saveData = () => {
  ...
  return commonExecuteApi({ queryId : 'HLTCA0020_SEARCH5_03_SAVE', list: [params] })
}
