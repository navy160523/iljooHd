  ...
  commonSearchApi({
    ...
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] == 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[4].data.push(res.ORESULT_CUR[0][columnName[i]]) //간담도계
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[3].data.push(res.ORESULT_CUR[1][columnName[i]]) //신경계
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[0].data.push(res.ORESULT_CUR[2][columnName[i]]) //이비인후계
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[6].data.push(res.ORESULT_CUR[3][columnName[i]]) //화학물질 관련
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[2].data.push(res.ORESULT_CUR[4][columnName[i]]) //조혈기계
      }
    }
    for (let i = 0; i < columnName.length; i++) {
      if (columnName[i] === 'GUBUN' || columnName[i] === 'CATEGORY') {
        ...
        chartsOptions.series[1].data.push(res.ORESULT_CUR[5][columnName[i]]) //호흡기계
      }
    }
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'E06'">
