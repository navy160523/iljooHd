...
const btnSearch = () => {
  ...
  commonSearchApi({
    ...
    for (let i = 0; i < chartValue.length; i++) {
      console.log('chartsOptions.series', chartsOptions.series)
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'B03'">
      ...
      <div class="d-flex flex-column fill-height">
        ...
        <v-card-text class="content-area">
          <v-sheet class="pa-0 h-auto">
            ...
            <div style="text-align: end">[단위:명]</div>
            <div>
              <v-sheet class="pa-0 h-auto">
                <RealGrid
                  ref="grdMain"
