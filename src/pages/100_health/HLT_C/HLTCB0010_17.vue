...
const searchParam = reactive({
  ...
  IND_CLS: 'D', //지표분류(건강행태)
  IND_NM: 'D04', //지표명(뇌심혈관계질환 고위험군 비율)
  BSNS_CD: '', //사업부
  DEPT_CD: '', //전체
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'D04'">
