...
const searchParam = reactive({
  ...
  IND_CLS: 'B', //지표분류(건강행태)
  IND_NM: 'B04', //지표명(협력사 건강관리위험대상자 비율)
  BSNS_CD: '', //사업부
  DEPT_CD: '', //전체
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'B04'">
