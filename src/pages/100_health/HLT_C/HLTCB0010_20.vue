...
const searchParam = reactive({
  ...
  IND_CLS: 'E', //지표분류(건강행태)
  IND_NM: 'E03', //지표명(작업환경측정 노출기준 초과배수)
  BSNS_CD: '', //사업부
  DEPT_CD: '', //전체
...
<template>
  <v-card class="pa-0 fill-height" v-if="ifValue == 'E03'">
    ...
    <v-card-text class="pa-3 pt-0 content-area">
      <div class="d-flex flex-column fill-height">
        ...
        <v-sheet class="pa-0 h-auto">
          ...
          <div style="text-align: end">[단위:배]</div>
          <div>
            <v-sheet class="pa-0 h-auto">
              <RealGrid
                ref="grdMain"
