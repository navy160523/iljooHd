...
import Popup1 from './HLTCA0020Tab5_02Popup1.vue'
...
const searchData = () => {
  ...
  return commonSearchApi({
    queryId: 'HLTCA0020_SEARCH5_02',
    param: props.searchParams,
  })
}

const afterSearch =  (res) => {
  // console.log("ress", res.ORESULT_CUR)
...
//   Object.keys(row).forEach((key) => {
//     // NULL을 0으로
//     if (row[key] === null || row[key] === "0" || row[key] === 0) {
//       row[key] = formatNumber(0);
//     }
//   });
// });
