...
const searchData = () => {
  ...
  return commonSearchApi({
    queryId: 'HLTCA0020_SEARCH5_04_POPUP',
    param: searchParam,
  })
}
...
const afterSearch = (res) => {
  ...
  // 숫자로 들어온 값을 그대로 매핑
  saveParams.ALL_HI = row.ALL_HI ?? null
  saveParams.ALL_LO = row.ALL_LO ?? null
}
...
const saveData = () => {
  ...
  return commonExecuteApi({ queryId : 'HLTCA0020_SEARCH5_04_SAVE', list: [params] })
}
