...
const grd1Props = reactive({
  ...
  fields : [ 
    ...
    { fieldName: 'WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('전체') } },
    { fieldName: 'EAR_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('이비인후계') }, },
    { fieldName: 'BONE_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('근골격계') }, },
    { fieldName: 'BREATH_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('호흡기계') }, },
    { fieldName: 'BLOOD_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('조혈기계') }, },
    { fieldName: 'BRAIN_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('뇌심혈관계') }, },
    { fieldName: 'SKIN_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('피부계') }, },
    { fieldName: 'NERVOUS_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('신경계') }, },
    { fieldName: 'ETC_WHOLE_CNT', width: '50', dataType: 'text', styleName: 'right-column', header: { text: t('기타') }, },
