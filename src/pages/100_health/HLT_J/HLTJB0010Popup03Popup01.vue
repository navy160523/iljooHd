...
const openPopup = (param) => {
  ...
  commonSearchApi({ queryId : 'HLTJB0010_SEARCH_05', param: search }).then(res => {
  ...
  if (btn.id === 'btnUpdate') {
    vm.$swal({ title: t('저장하시겠습니까?'), showCancelButton: true }).then(res => {
      ...
      if (res.isConfirmed) {
        ...
        commonExecuteApi({ queryId : 'HLTJB0010_SAVE_06', list: [ searchParams ] }).then(res => {
      ...
      <table class="pa-4" ref="content">
        <tbody>
            ...
            <tr>
              ...
              <td colspan=2 class="text-left pl-2 text-box">{{ searchParams.WORK_STANDARD_NM }}</td>
              ...
              <td class="text-left" colspan=6>
                <div class="d-flex">
                  ...
                  <v-radio-group
                    ...
                    :readonly="searchParams.WORK_EVAL !== 'Y'"
                  >
