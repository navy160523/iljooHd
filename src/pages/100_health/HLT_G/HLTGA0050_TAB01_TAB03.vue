<!-- 
  화면명 : 특수검진 유해인자
  화면개요 : 특수검진 유해인자 TAB03 부서규제물질 관리
-->
<script setup>
...
const grd1Props = reactive({
  ...
  fields : [ 
    ...
    { fieldName: 'MATDSC', width: '60', editable: false, styleName: 'left-column', dataType: 'text', header: { text: t('제품명') } },
...
//  조회
const searchData = () => {
  return commonSearchApi({ queryId: 'HLTGA0050_SEARCH_03', param: searchParams })
}
