...
const grdMainProps = reactive({
  ...
  keys: [],
  fields: [
    { fieldName: 'OCUR_DATE', width: '60', dataType: 'datetime', datetimeFormat: 'yyyy-MM-dd', header: { text: t('발생일자') }, },
    { fieldName: 'DIVISION', width: '60', dataType: 'text', header: { text: t('분류') }, },
    { fieldName: 'CHECK_STEP', width: '60', dataType: 'text', header: { text: t('확인단계') }, },
    { fieldName: 'REQ_DEPT_NM', width: '60', dataType: 'text', header: { text: t('청구부서') }, },    
    { fieldName: 'BUY_DEPT_NM', width: '60', dataType: 'text', header: { text: t('구매부서'), styleName: 'multiline-editor-pre' } },
    { fieldName: 'MATNO', width: '80', dataType: 'text', header: { text: t('자재번호'), styleName: 'multiline-editor-pre' } },
    { fieldName: 'MATDSC', width: '120', dataType: 'text', styleName: 'left-column', header: { text: t('품명'), styleName: 'multiline-editor-pre' } },
    { fieldName: 'RESTRICT', width: '60', dataType: 'text', header: { text: t('규제물질') } },
    { fieldName: 'RELEVANT_BASIS', width: '120', dataType: 'text', styleName: 'left-column', header: { text: t('관련근거'), styleName: 'multiline-editor-pre' } },
    { fieldName: 'ACTION_DETAIL', width: '120', dataType: 'text', styleName: 'left-column', header: { text: t('조치상세'), styleName: 'multiline-editor-pre' } },
    { fieldName: 'STATUS_DIV', width: '60', dataType: 'text', header: { text: t('상태구분'), styleName: 'multiline-editor-pre' } },
...
const searchData = () => {
  ...
  return commonSearchApi({ queryId: 'HLTDA0060_SEARCH_03', param: searchParams })
}
