...
import HLTHB0010Popup04 from "./HLTHB0010Popup04.vue";
...
const hLTHB0010Popup04 = ref(null);
const shoesKindArray = ref([]);
...
const onCellDblClicked = async(grid, clickData) =>{
  ...
  hLTHB0010Popup04.value.openPopup(dataParam);
}
...
<template>
  ...
  <HLTHB0010Popup04 ref="hLTHB0010Popup04" />
</template>
