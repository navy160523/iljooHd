...
const grdMainProps1 = reactive({
  ...
  fields: [
    ...
    { fieldName: "SHOES_GUBN", width: "130", dataType: "text", header: { text: t("안전장화 종류") }, lookupDisplay: true, styleName: 'left-column', footer: { text: '합계', styleName: 'center-column' } },
...
const searchData = () => {
  ...
  return Promise.all([
    commonSearchApi({ queryId: 'HLTHB0040_SEARCH_02', param: mainParams}),
    commonSearchApi({ queryId: 'HLTHB0040_SEARCH_02', param: marineParams}),
    commonSearchApi({ queryId: 'HLTHB0040_SEARCH_02', param: gunsanParams}),
    commonSearchApi({ queryId: 'HLTHB0040_SEARCH_03', param: gunsanParams}),
  ])
}
...
const saveData = () => {
  return commonExecuteApi({ queryId: 'HLTHB0040_SAVE_02', list: saveParams })
}
