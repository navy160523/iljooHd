...
const searchData = () => {
  ...
  return Promise.all([
    commonSearchApi({ queryId: 'HLTHA0050_SEARCH_04', param: props.searchParams}),  // 전년도 이월
    commonSearchApi({ queryId: 'HLTHA0050_SEARCH_05', param: props.searchParams}),  // 재고 현황
  ])
}
