...
const grdMainProps = reactive({
  ...
  columnLayout: [
    ...
    "REQ_CHA_DT_NM",
    {
      ...
      items: ["GLASSES_COUNT_1", "GLASSES_COUNT_2", "GLASSES_COUNT"],
    },
    {
      name: "지급수량",
      direction: "horizontal",
      items: ["RECEIVE_COUNT_1", "RECEIVE_COUNT_2", "RECEIVE_COUNT"],
    },
  ],
});
