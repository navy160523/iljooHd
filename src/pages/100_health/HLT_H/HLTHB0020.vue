<!-- 
  화면명 : 안전장화 신청/접수 이력 관리 
  화면개요 : 안전장화 신청/접수 이력 관리 
-->
<script setup>
...
import HLTHB0020Popup01 from "@/pages/100_health/HLT_H/HLTHB0020Popup01.vue";
import HLTHB0020Popup02 from "@/pages/100_health/HLT_H/HLTHB0020Popup02.vue";
import HLTHB0020Popup03 from "@/pages/100_health/HLT_H/HLTHB0020Popup03.vue";
import HLTHB0020Popup04 from "@/pages/100_health/HLT_H/HLTHB0020Popup04.vue";
import HLTHB0020Popup05 from "@/pages/100_health/HLT_H/HLTHB0020Popup05.vue";

defineOptions({
  name: "100_health-HLT_H-HLTHB0020",
});
...
const hLTHB0020Popup01 = ref(null);
const hLTHB0020Popup02 = ref(null);
const hLTHB0020Popup03 = ref(null);
const hLTHB0020Popup04 = ref(null);
const hLTHB0020Popup05 = ref(null);
...
const initCodeList = async () => {
  Promise.all([
    ...
    codeList.PLACE_CD = res[4].ORESULT_CUR;

    codeList.BSNS_CD = res[5].ORESULT_CUR;
    codeList.DEPT_CD = res[6].ORESULT_CUR;
...
const onButtonsClick = async (btn) => {
  ...
  if (btn.id === "btnSearch") {
    ...
    hLTHB0020Popup02.value.openPopup(searchParams);
    ...
    vm.$swal({
      ...
      if (res.isConfirmed === true) {
        hLTHB0020Popup01.value.openPopup(searchParams);
      }
    });
    ...
    hLTHB0020Popup03.value.openPopup(dt, "5");
    ...
    hLTHB0020Popup03.value.openPopup(dt, "3");
    ...
    if(rowList.length > 0){
      hLTHB0020Popup05.value.openPopup(rowList);
    }else{
      return Message.warn(t("메일 발송 대상을 선택해주세요."));
    }
...
const searchDataRegular = async () => {
  ...
  const res = await commonSearchApi({
    queryId: "HLTHB0020_SEARCH_REGULAR",
    param: {
...
const saveData = () => {
  ...
  return commonExecuteApi({ queryId: "HLTHB0020_SAVE_05", list: saveParams });
};
...
const onCellDblClicked = (grid, clickData) => {
  ...
  if (
    ...
    return;
  hLTHB0020Popup04.value.openPopup(data);
};
...
<template>
  <v-card class="pa-0 fill-height">
    ...
    <v-card-text class="pa-3 pt-0 content-area">
      ...
      <!-- 팝업존 -->
      <HLTHB0020Popup01 ref="hLTHB0020Popup01" @after-search="afterPop" />
      <HLTHB0020Popup02 ref="hLTHB0020Popup02" @after-search="afterPop" />
      <HLTHB0020Popup03
        ref="hLTHB0020Popup03"
        @after-search="onButtonsClick({ id: 'btnSearch' })"
      />
      <HLTHB0020Popup04 ref="hLTHB0020Popup04" />
      <HLTHB0020Popup05 ref="hLTHB0020Popup05" @send-notify="sendMail" />
    </v-card-text>
  </v-card>
</template>
