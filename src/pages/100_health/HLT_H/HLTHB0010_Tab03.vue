...
import HLTHB0010Popup02 from "./HLTHB0010Popup02.vue";
...
const hLTHB0010Popup02 = ref(null);
const subTitle = ref("");
...
const setGridItem = async () => {
  ...
  grdMain.value.getGridView().onCellButtonClicked = function (
    ...
    hLTHB0010Popup02.value.openPopup(param);
  };
...
<template>
  ...
  <HLTHB0010Popup02 ref="hLTHB0010Popup02" />
