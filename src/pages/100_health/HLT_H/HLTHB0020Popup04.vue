...
const grdMainProps = reactive({
  ...
  fields: [
    ...
    { fieldName: 'SHOES_KIND', width: '120', editable : false, dataType: 'text', header: { text: t('안전장화 종류') }, lookupDisplay: true },
...
//  조회
const searchData = () => {
  return commonSearchApi({ queryId: 'HLTHB0020_SEARCH_06', param: searchParams })
}
