...
const tab03tab02Field = reactive({
...
const setFieldTab02 = (data) => {
  if (data) {
    for (const [key, value] of Object.entries(data)) {
      if (tab03tab02Field.hasOwnProperty(key)) {
        tab03tab02Field[key] = value
      }
    }
  }
}
...
<template>
  <v-sheet class="searchArea">
    ...
    >
    <div>
      <v-radio-group v-model="tab03tab02Field.P2_QA0_C1">
    ...
    <table>
      <tr>
        <td>통증부위</td>
        <td>
          <v-checkbox label="목" true-value="Y" false-value="N" v-model="tab03tab02Field.P2_QY0_C1"></v-checkbox>
        </td>
        <td>
          <v-checkbox label="어깨" true-value="Y" false-value="N" v-model="tab03tab02Field.P2_QY0_C2"></v-checkbox>
        </td>
        <v-checkbox label="팔/팔꿈치" true-value="Y" false-value="N" v-model="tab03tab02Field.P2_QY0_C3"></v-checkbox>
        ...
        <td>
          <v-checkbox
            ...
            true-value="Y"
            false-value="N"
            v-model="tab03tab02Field.P2_QY0_C4"
          ></v-checkbox>
        </td>
        <td>
          <v-checkbox label="허리" true-value="Y" false-value="N" v-model="tab03tab02Field.P2_QY0_C5"></v-checkbox>
        </td>
        <td>
          <v-checkbox label="다리/발" true-value="Y" false-value="N" v-model="tab03tab02Field.P2_QY0_C6"></v-checkbox>
        </td>
      </tr>
      <tr>
        <td>1.통증의 구체적 부위는?</td>
        <td><보기></td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY1_C2_I632">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY1_C3_I632">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY1_C4_I632">
            <v-radio
              :label="item.TXT"
        ...
        <td></td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY1_C6_I632">
            <v-radio
              :label="item.TXT"
      ...
      <tr>
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY2_C1_I633">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY2_C2_I633">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY2_C3_I633">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY2_C4_I633">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY2_C5_I633">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY2_C6_I633">
            <v-radio
              :label="item.TXT"
      ...
      <tr>
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY3_C1_I634">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY3_C2_I634">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY3_C3_I634">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY3_C4_I634">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY3_C5_I634">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY3_C6_I634">
            <v-radio
              :label="item.TXT"
      ...
      <tr>
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY4_C1_I635">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY4_C2_I635">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY4_C3_I635">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY4_C4_I635">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY4_C5_I635">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY4_C6_I635">
            <v-radio
              :label="item.TXT"
      ...
      <tr>
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY5_C1">
            <v-radio label="아니오" value="N"> </v-radio>
            <v-radio label="예" value="Y"></v-radio>
          </v-radio-group>
        </td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY5_C2">
            <v-radio label="아니오" value="N"> </v-radio>
            <v-radio label="예" value="Y"></v-radio>
          </v-radio-group>
        </td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY5_C3">
            <v-radio label="아니오" value="N"> </v-radio>
            <v-radio label="예" value="Y"></v-radio>
          </v-radio-group>
        </td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY5_C4">
            <v-radio label="아니오" value="N"> </v-radio>
            <v-radio label="예" value="Y"></v-radio>
          </v-radio-group>
        </td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY5_C5">
            <v-radio label="아니오" value="N"> </v-radio>
            <v-radio label="예" value="Y"></v-radio>
          </v-radio-group>
        </td>
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY5_C6">
            <v-radio label="아니오" value="N"> </v-radio>
            <v-radio label="예" value="Y"></v-radio>
          </v-radio-group>
        </td>
      ...
      <tr>
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY6_C1_I636">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY6_C2_I636">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY6_C3_I636">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY6_C4_I636">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY6_C5_I636">
            <v-radio
              :label="item.TXT"
        ...
        <td>
          <v-radio-group v-model="tab03tab02Field.P2_QY6_C6_I636">
            <v-radio
              :label="item.TXT"
