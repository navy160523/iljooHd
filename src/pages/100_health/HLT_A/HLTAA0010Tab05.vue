<!-- 
  일주지앤에스 SI2팀 장필구
  보건 위험성 평가 > 기초 정보 관리 > 위험성 보정기준 관리(탭)
-->
<script setup>
...
const grdMainProps = reactive({
  ...
  fields : [ 
    { fieldName: 'EVALUATION_FIELD_NM', dataType: 'text', header: { text: t('평가 분야') }, width: "10",  editable: false},
    { fieldName: 'DIVISION', dataType: 'text', header: { text: t('구분') }, width: "10", editable: false},
    { fieldName: 'DISEASE_CD', dataType: 'text', header: { text: t('질병코드') }, width: "10", editable: false},
    { fieldName: 'DISEASE_NM', dataType: 'text', header: { text: t('명칭') }, width: "50", editable: false, styleName: "left-column"},
    // 안보이는거
...
const deleteData = () => { 
  ...
  return commonExecuteApi({ queryId : 'HLTAA0010_DELETE_05', list: saveParams })
}
...
<div class="d-flex flex-column fill-height">
  ...
  <!-- 팝업존 -->
  <HLTAA0010Tab05Popup01 ref="CreatePopup" @closed="onPopupClosedPopUp01"/> <!-- 추가 -->
  <HLTAA0010Tab05Popup02 ref="CopyPopup" @closed="onPopupClosedPopUp01"/> <!-- 추가 -->
