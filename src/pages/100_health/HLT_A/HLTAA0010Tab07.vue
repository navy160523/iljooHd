<!-- 
  일주지앤에스 SI2팀 장필구
  보건 위험성 평가 > 기초 정보 관리 > 감소대책 가이드 관리(탭)
-->
<script setup>
...
import HLTAA0010Tab07Popup01 from '@/pages/100_health/HLT_A/HLTAA0010Tab07Popup01.vue'
import HLTAA0010Tab07Popup02 from '@/pages/100_health/HLT_A/HLTAA0010Tab07Popup02.vue'
...
const grdMainProps = reactive({
  ...
  fields : [ 
    { fieldName: 'CATEGORY_MA_NM', dataType: 'text', header: { text: t('구분') }, width: "10",  editable: false},
    { fieldName: 'RISK_CLASS_NM', dataType: 'text', header: { text: t('위험성 분류') }, width: "10", editable: false},
    { fieldName: 'MAG_CD', dataType: 'text', header: { text: t('관리코드') }, width: "10", editable: false},
    { fieldName: 'GUIDE', dataType: 'text', header: { text: t('대책수립 가이드') }, width: "100", editable: false, styleName: "left-column"},
    // 안보이는거
...
const deleteData = () => { 
  ...
  return commonExecuteApi({ queryId : 'HLTAA0010_DELETE_07', list: saveParams })
}
...
const onButtonsClickTab02 = btn => {
  if (btn.id === 'btnGetPastCorrectionCriteria') {
...
<div class="d-flex flex-column fill-height">
  ...
  <!-- 팝업존 -->
  <HLTAA0010Tab07Popup01 ref="CreatePopup" @closed="onPopupClosedPopUp01"/> <!-- 추가 -->
  <HLTAA0010Tab07Popup02 ref="CopyPopup" @closed="onPopupClosedPopUp01"/> <!-- 추가 -->
