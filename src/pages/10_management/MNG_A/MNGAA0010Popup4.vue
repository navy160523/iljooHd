<!--
  화면명 : MNGAA0010Popup4.vue
  화면개요 :HSE 경영시스템 모니터링 -> 업무분장표 팝업
-->
<script setup>
...
const grdMainProps = reactive({
  ...
  field: [
    ...
    { fieldName: "ASGN_CNT", dataType: "text", width: '70', editable: false, header: { text: t("부서수") } },
    { fieldName: "Y_CNT", dataType: "text", width: '70', editable: false, header: { text: t("완료") } },
    { fieldName: "N_CNT", dataType: "text", width: '70', editable: false, header: { text: t("미완료") } },
    { fieldName: "Y_RATE", dataType: "text", width: '70', editable: false, header: { text: t("완료율(%)") } },
...
const grdSub1Props = reactive({
  ...
  field: [
    { fieldName: "BSNS_NM", dataType: "text", styleName: "left-column", editable: false, header: { text: t("사업부") } },
    { fieldName: "ASGN_NM", dataType: "text", styleName: "left-column", editable: false, header: { text: t("부서") } },
    { fieldName: "WRITE_YN", dataType: "text", width: '70', editable: false, header: { text: t("작성 유무") } },
    { fieldName: "WRITE_EMP_NM", dataType: "text", width: '70', editable: false, header: { text: t("작성자") } },
    { fieldName: "WRITE_DATE", dataType: "text", width: '70', editable: false, header: { text: t("작성일자") } },
    { fieldName: "ZZ_APP_STATUS_DES", dataType: "text", lookupDisplay: true, styleName: "left-column", editable: false, header: { text: t("진행상태") } },
    { fieldName: "REMARKS", dataType: "text", lookupDisplay: true, styleName: "left-column", editable: false, header: { text: t("비고") } },
...
// 조회로직
const searchData = () => {
  return commonSearchApi({ queryId : 'MNGAA0010_POPUP_04_SEARCH_01', param: searchParams }) 
}
...
const onGrdMainCellClicked = async (grid, oldRow, newRow) => {
  ...
  commonSearchApi({ queryId : 'MNGAA0010_POPUP_04_SEARCH_02', param: searchParams2 }).then( res => {  
