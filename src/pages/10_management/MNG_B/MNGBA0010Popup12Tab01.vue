...
const grdMainProps = reactive({
  ...
  [ 
    ...
    { fieldName: 'TARGET_CNT', dataType: 'number', header: { text: t('대상인원') }, styleName: 'right-column', numberFormat:"#,###", editable: false },
    { fieldName: 'SUM_PASS', dataType: 'number', header: { text: t('이수인원') }, styleName: 'right-column', numberFormat:"#,###", editable: false },
...
const grdSubProps1 = reactive({
  ...
  [ 
    ...
    { fieldName: 'TARGET_CNT', dataType: 'number', header: { text: t('대상인원') }, styleName: 'right-column', numberFormat:"#,###", footer: { numberFormat: "#,###",expression: "sum" }, editable: false },
    { fieldName: 'EDU_CNT', dataType: 'number', header: { text: t('이수인원') }, styleName: 'right-column', numberFormat:"#,###", footer: { numberFormat: "#,###",expression: "sum" }, editable: false },
...
const searchData = idx => {
  ...
  return commonSearchApi({ queryId : 'EDUAB0020_SEARCH_03', param: searchParams })
}
...
const searchParam = param => {
  ...
  searchParams.EDU_DATE_FROM1 = param.FROM_DT
  searchParams.EDU_DATE_TO1 = param.TO_DT
  searchParams.BSNS_CD = param.BSNS_CD
  searchParams.EDU_TITLE = param.CURR_NM
  searchParams.ASGN_CD = ''
  searchParams.ASGN_CD_NM = ''
        ...
        <div class="d-flex flex-column fill-height">
          <v-sheet class="searchArea d-flex">
            ...
            <i-input 
              :label="$t('교육명')"
              width="330px"
              v-model="searchParams.EDU_TITLE" 
              append-inner-icon="mdi-magnify" 
