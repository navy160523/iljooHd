  ...
  <v-card class="pa-3 fill-height">
    ...
    <v-card-text class="pa-2 pt-0 content-area p-relative">
      <v-sheet min-height="700" class="content-body">
        <v-sheet max-width="100%" width="100%" class="searchArea d-flex">
          <i-input
            :label="$t('년도')"
            labelWidth="35px"
        ...
        <v-window v-model="tab" class="mt-3">
          <v-window-item value="tab1">
            <v-sheet class="h-auto d-flex flex-row">
          ...
          <v-window-item value="tab2" class="v-sheet flex-row">
            <v-col class="pa-0 mr-2">
              <IGridTitle :title="$t('작성정보')">
                <template #editors />
              </IGridTitle>
            ...
            <v-sheet width="50%" class="pa-0 ml-2 content-body">
              <v-sheet class="mb-3 flex-column">
                <IGridTitle :title="$t('추가정보')">
                  <template #editors />
                </IGridTitle>
                <v-card color="#F4F5F9" class="py-2 px-4">
                  <p>contents 1</p>
                  <p>contents 2</p>
                  <p>contents 3</p>
                  <p>contents 4</p>
