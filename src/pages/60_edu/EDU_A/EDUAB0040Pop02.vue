<!--
  화면명 : 제외 요청(팝업)
  화면개요 : 개인의 교육 일정을 제외시킬 수 있는 팝업이다.
-->
<script setup>
...
const openPopup =  (data) => {
  ...
  popupData.LECTURER_ID = data.selectRow.LECTURER_NM
  popupData.EDUPOSSIBLE_NUM = data.selectRow.EDUPOSSIBLE_NUM
  popupData.EDU_CONTENT = data.selectRow.EDU_CONTENT
...
const saveData = () => {
  return commonExecuteApi({ queryId : 'EDUAB0040_SAVE_02', list: [popupData] })
}
...
<template>
  ...
  <v-card class="pa-0 fill-height rounded-b-5">
    ...
    <div class="pa-2 d-flex flex-column fill-height">
      <v-sheet class="pl-2 searchArea flex-column">
