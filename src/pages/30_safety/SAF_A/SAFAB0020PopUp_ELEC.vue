<!--     일주지앤에스 SI2팀 김성근    -->
<!--     일주지앤에스 SI2팀 김성근    -->
<!--  프로그램명 : 사고 세부사항 팝업 (일렉용)    -->

<script setup>
import { ref, reactive, onMounted, watch } from "vue"
import { commonRequest, commonShortenUrl } from "@hiway/api/commonApi"
...
import SAFAB0020PopUpTab1 from "@/pages/30_safety/SAF_A/SAFAB0020PopUpTab1_ELEC.vue"
import SAFAB0020PopUpTab2 from "@/pages/30_safety/SAF_A/SAFAB0020PopUpTab2_ELEC.vue"
...
const searchData = async () => {
  ...
  await commonRequest("/hse/safety/SEARCH", {
    queryId: "SAFAB0020_ELEC_search03",
    param: param,
  }).then((res) => {
  ...
  >
    <VContainer style="background-color: white; height: 100%; min-height: 100%">
      <v-tabs v-model="tab" class="align">
        ...
        <v-tab value="사고 보고서" v-if="(visibleSago || visibleSagoAM) && dataInner[0].SAGO_DIV_L !== 'B'">{{
          t("사고 보고서")
        }}</v-tab>
