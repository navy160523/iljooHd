...
import TAB01 from "./SAFAA0010_TAB01_ELEC.vue"
import TAB02 from "./SAFAA0010_TAB02_ELEC.vue"
...
const TongParam = async (e) => {
  ...
  await commonSearchApi({ queryId: "SAFAA0010_ELEC_search02", param: e })
    .then((res) => {
...
const SearchParam = async (e) => {
  ...
  await commonSearchApi({ queryId: "SAFAA0010_ELEC_search01", param: searchData })
    .then((res) => {
  ...
  <v-card class="pa-0 fill-height">
    ...
    <v-card-text class="pa-3 pt-0 content-area">
      <v-sheet class="d-flex flex-column fill-height">
        <v-sheet>
          <VTabs v-model="tab">
            <VTab value="accident">사고 대시보드</VTab>
            <VTab value="Tong">통계 대시보드</VTab>
          </VTabs>
        </v-sheet>
