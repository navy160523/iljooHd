...
import SAFDC0010_02Tab01Popup from './SAFDC0010_02Tab01Popup.vue'
...
const searchParam = reactive({
  ...
  SEND_DEPT_CD: '', //부서
  SEND_BSNS_CD: 'AN00', //sliSAFDC0010_02Tab01 === undefined ? userStore.bsnsCd : '', //사업부
  ...
  REC_DEPT_CD: sliSAFDC0010_02Tab01 === undefined ? userStore.deptCd : sliSAFDC0010_02Tab01.DEPT_CD, //부서
  SUBJECT_CD: '', //분야
...
const defaultDate = () => {
  ...
  searchParam.REQ_REPLY_TO =
    ...
    if (sliSAFDC0010_02Tab01 === undefined
        && (userStore.authGrpCd.includes('GRP00381') || userStore.authGrpCd.includes('GRP00369'))) {
