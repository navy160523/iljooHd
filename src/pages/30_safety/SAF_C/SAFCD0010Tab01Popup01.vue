...
import SAFCD0010Tab01Popup01Tab01 from './SAFCD0010Tab01Popup01Tab01.vue'
import SAFCD0010Tab01Popup01Tab02 from './SAFCD0010Tab01Popup01Tab02.vue'
...
const noSearchCloseYN = ref(false)
...
const closePopup = () => {
  ...
  if(noSearchCloseYN.value){
    noSearchCloseYN.value = false    
  } else {
    emit('closePopup')
  }
}
