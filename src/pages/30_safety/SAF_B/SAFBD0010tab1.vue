...
const grdMainProps = reactive({
  ...
  fields : [ 
    { fieldName: 'COL1', dataType: 'text', header: { text: t('대분류') } },
    { fieldName: 'COL2', dataType: 'text', header: { text: t('중분류') } },
    { fieldName: 'COL3', dataType: 'text', header: { text: t('지번') } },
    { fieldName: 'COL4', dataType: 'text', header: { text: t('위험작업 장소구분') } },
  ],
  columns : [],
})
