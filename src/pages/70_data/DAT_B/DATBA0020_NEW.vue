...
defineOptions({
  name:'70_data-DAT_B-DATBA0020_NEW',
})
...
const grdMainProps = reactive({
  ...
  fields : [ 
    ...
    { fieldName: 'REQ_TEL_NO', dataType: 'text' , visible: false },
    ...
    { fieldName: 'REQ_NOTICE_FILEID2', dataType: 'text' , visible: false },
  ],
  columns : [],
})
...
const searchData = () => {
  ...
  return commonRequest("/hse/data/DATBA0010_SELECT_CLOB01", 
    { 
      queryId: "DATBA0010_SELECT_04", 
      param: sendParams,
    })
}
...
const onCellDblClicked = (grid, clickData) => {
  ...
  if (clickData.cellType !== "header") {
    dATBA0010PopupReq.value.openPopup(row, userLogStore.isMenuAdmin ,'EDIT')
  }
}
