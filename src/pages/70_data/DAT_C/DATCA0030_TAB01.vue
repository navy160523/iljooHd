...
const searchData = () => {
  //searchParams.DATE_FROM = searchParams.DATE_FROM ? dayjs(searchParams.DATE_FROM).format('YYYYMMDD') : null
  // searchParams.DATE_TO = searchParams.DATE_TO ? dayjs(searchParams.DATE_TO).format('YYYYMMDD') : null
