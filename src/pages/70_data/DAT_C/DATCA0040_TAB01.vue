...
const initCodeList = () => {
  grdMain.value.setBindingColumn("NOTICE_DIV", cmpnyGubun, "COD", "TXT")
}
...
const onButtonsClick = (btn) => {
  if (btn.id === "btnSearch") {
    ...
    Popup.value.openPopup(critical.value)
  }
}
...
<template>
  ...
  <DATCA0040Popup ref="Popup" id="1" @after-search="() => onButtonsClick({ id: 'btnSearch' })"></DATCA0040Popup>
</template>
