...
import DATCA0020Popup2 from "./DATCA0020Popup2.vue"
...
const grdMainProps = reactive({
  ...
  fields: [
    ...
    { fieldName: "YOUTUBE_LINK", dataType: "text", header: { text: t("YOUTUBE_LINK") }, visible: false },
  ],
  columns: [],
})
