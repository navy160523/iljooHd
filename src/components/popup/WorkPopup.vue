...
const grdMainProps = reactive({
  ...
  fields : [ 
    ...
    { fieldName: 'WORK_STANDARD_NM', dataType: 'text', editable: false, width: '250', header: { text: t('작업표준명') } },
  ]
})
...
const grdSubProps = reactive({
  ...
  fields : [
    ...
    { fieldName: 'ACT_NM', dataType: 'text', editable: false, width: '170', styleName: 'left-column', header: { text: t('작업행동') } },
    { fieldName: 'CHK_NM', dataType: 'text', editable: false, width: '170', styleName: 'left-column',header: { text: t('체크정보') } },
    { fieldName: 'RISK_NM', dataType: 'text', editable: false, width: '170', styleName: 'left-column', header: { text: t('위험요인') } },
    { fieldName: 'RM_NM', dataType: 'text', editable: false, width: '170', styleName: 'left-column', header: { text: t('감소대책') }},
...
const onCellDblClicked = (grd, data) => {
  const row = grdMain.value.getDataProvider().getJsonRow(data.dataRow)
